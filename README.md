...
A responsive Best Sellers product grid/carousel built with HTML, JavaScript, and TailwindCSS. Mobile: 2-column grid with "Show More" to reveal more products. Desktop: horizontal carousel with custom scrollbar.

## How to run

Open `index.html` in a browser, or use a local server (e.g. Live Server in VS Code, or `npx serve`). No build step required.
...
**Objective:** The aim is to see your thinking & process along with creating the designs. Please create a Git Repository for the work and add as many Commits as you think will help showcase your development process.

**Once completed:** Please send through a link to the completed Git repository. The preview should be as simple as opening the main HTML file, or alternatively host the example online for preview. There should be no local build step required to review the final result.
